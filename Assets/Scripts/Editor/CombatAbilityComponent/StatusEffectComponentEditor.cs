...
public class StatusEffectComponentEditor : PropertyDrawer
{
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        property.isExpanded = EditorGUI.Foldout(new Rect(position.x, position.y, position.width, singleLineHeight), property.isExpanded, label);
    ...
    public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
    {
        ...
        if (property.isExpanded)
        {
            ...
            return newLineHeight * statusEffectCount + newLineHeight;
        }
        else
        {
