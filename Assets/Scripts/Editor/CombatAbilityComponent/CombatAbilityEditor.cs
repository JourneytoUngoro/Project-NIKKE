...
public class CombatAbilityEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        {
            EditorGUILayout.HelpBox("Caution: Shield & Parry difference between Damage Component and Knockback Component", MessageType.Error);
        }
            ...
            foreach (Type combatAbilityComponentType in combatAbilityComponentTypes)
            {
                if (GUILayout.Button(combatAbilityComponentType.Name))
                {
                    ...
                    else
                    {
                        ...
                        Debug.Log("Pertained to: " + combatAbilityComponent.pertainedCombatAbility);
