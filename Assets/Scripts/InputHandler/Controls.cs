...
//     version 1.6.3
//     from Assets/Scripts/InputHandler/Player.inputactions
//
...
public partial class @Controls: IInputActionCollection2, IDisposable
{
    ...
    ""controlSchemes"": [
        ...
        m_InGame_WideAttack = m_InGame.FindAction("WideAttack", throwIfNotFound: true);
        m_InGame_Ultimate = m_InGame.FindAction("Ultimate", throwIfNotFound: true);
        m_InGame_UpperSlash = m_InGame.FindAction("UpperSlash", throwIfNotFound: true);
    ...
    private readonly InputAction m_InGame_WideAttack;
    private readonly InputAction m_InGame_Ultimate;
    private readonly InputAction m_InGame_UpperSlash;
    ...
    public struct InGameActions
    {
        ...
        public InputAction @WideAttack => m_Wrapper.m_InGame_WideAttack;
        public InputAction @Ultimate => m_Wrapper.m_InGame_Ultimate;
        public InputAction @UpperSlash => m_Wrapper.m_InGame_UpperSlash;
        ...
        public void AddCallbacks(IInGameActions instance)
        {
            ...
            @WideAttack.started += instance.OnWideAttack;
            @WideAttack.performed += instance.OnWideAttack;
            @WideAttack.canceled += instance.OnWideAttack;
            @Ultimate.started += instance.OnUltimate;
            @Ultimate.performed += instance.OnUltimate;
            @Ultimate.canceled += instance.OnUltimate;
            @UpperSlash.started += instance.OnUpperSlash;
            @UpperSlash.performed += instance.OnUpperSlash;
            @UpperSlash.canceled += instance.OnUpperSlash;
    ...
    public interface IInGameActions
    {
        ...
        void OnWideAttack(InputAction.CallbackContext context);
        void OnUltimate(InputAction.CallbackContext context);
        void OnUpperSlash(InputAction.CallbackContext context);
